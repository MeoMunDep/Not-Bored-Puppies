...
> Help me with your referral [Link](https://t.me/NotBoredPuppies_bot?start=r_6713068747)
...
```json
{
  ...
  "countdown": 300,
  "country_time": "en-US",
  "ugradeRechargingSpeed": 1,
  "upgradeMultiTap": 1,
  "upgradeEnergyLimit": 1,
  "DoDailyCombo": true,
  "dailyCombo": [0, 1, 2],
  "doTasks": true,
  "delayEachAccount": [1, 82]
}
```
...
> To run the bot, use the following command: `cd "not-bored-puppies-main/not-bored-puppies"; node meomundep`
